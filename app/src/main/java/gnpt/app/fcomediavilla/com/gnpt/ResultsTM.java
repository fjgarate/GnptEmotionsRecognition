...
public class ResultsTM extends AppCompatActivity {
    ...
    TextView percentage, corrects, mistakes, omissions, scores, percentageGraphic, averageValGraphic, averageEngGraphic, averageAttGraphic, framesDetectedGraphic, framesNoFaceGraphic;
    String percentage_str, corrects_str, mistakes_str, tarea, omissions_str, score_str, numFramesDetected_str, numFramesNoFace_str, att_average_str, val_average_str, eng_average_str, idUser;
    int correct, mistake, omission, score, percentageInt, framesDetected, framesNoFace;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Results newResults = new Results(idUser, getCurrentTimeStamp(), Login.idSesion, Login.numSesion, tarea, percentageInt, correct, mistake, omission, score, -1, -1, -1, -1, framesDetected, framesNoFace, emotion);
        ...
        if (result.equals("OK")) {
            ...
            if (db != null) {
                try {
                    ...
                    if (contadorResults > 0) {
                        ...
                        new Progress().execute(baseUrl, resultFromDBJson);
                    }
                }catch (Exception e) {
            ...
            if (db != null) {
                ...
                try {
                    ...
                    values.put(Contract.ResultsTable.TASK, tarea);
                    ...
                    values.put(Contract.ResultsTable.TIME_TOTAL, -1);

...
public class StatementTap extends AppCompatActivity implements CameraDetector.CameraEventListener,Detector.ImageListener{
    /// /----- Affectiva
    int previewWidth = 0;
    int previewHeight = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainLayout = (LinearLayout) findViewById(R.id.statement_tap);

...
public class StatementFlex extends AppCompatActivity implements CameraDetector.CameraEventListener,Detector.ImageListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainLayout = (LinearLayout) findViewById(R.id.statement_flex);

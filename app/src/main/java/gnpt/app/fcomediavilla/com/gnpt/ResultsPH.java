...
public class ResultsPH extends AppCompatActivity {
    ...
    TextView percentage, corrects, mistakes, omissions, scores, totalTime, percentageGraphic;
    String percentage_str, corrects_str, mistakes_str, omissions_str, time_str, score_str;
    int correct, mistake, omission, score, timer, percentageInt;
    int numPhotos = 10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Results newResults = new Results(Login.idUser, date, Login.idSesion, Login.numSesion, "Photos", percentageInt, correct, mistake, omission, score, timer, -1, -1, -1);

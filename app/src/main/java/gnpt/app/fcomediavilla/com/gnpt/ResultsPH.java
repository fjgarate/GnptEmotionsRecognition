...
/**
 * Created by SalmonManin on 20/03/2017.
 */

public class ResultsPH extends AppCompatActivity {

    TextView percentage, corrects, mistakes, omissions, scores, totalTime, percentageGraphic, averageValGraphic, averageEngGraphic, averageAttGraphic, framesDetectedGraphic, framesNoFaceGraphic;
    String percentage_str, corrects_str, mistakes_str, omissions_str, time_str, score_str,  numFramesDetected_str, numFramesNoFace_str, att_average_str, val_average_str, eng_average_str, idUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.results_photos);

        percentage = (TextView) findViewById(R.id.percentage_PH);
        corrects = (TextView) findViewById(R.id.corrects_PH);
        mistakes = (TextView) findViewById(R.id.mistakes_PH);
        omissions = (TextView) findViewById(R.id.omissions_PH);
        scores = (TextView) findViewById(R.id.score_PH);
        totalTime = (TextView) findViewById(R.id.total_time_PH);
        pbPercentage = (ProgressBar) findViewById(R.id.pbPercentage_PH);
        percentageGraphic = (TextView) findViewById(R.id.percentage_graphic_PH);
        ...
        omission = numPhotos - correct - mistake;
        ...
        Results newResults = new Results(idUser, getCurrentTimeStamp(), Login.idSesion, Login.numSesion, "Photos", percentageInt, correct, mistake, omission, score, timer, -1, -1, -1, framesDetected, framesNoFace, emotion);
    ...
    public String getPercentage(int correct){
        percentageInt = Math.round(((float)correct/numPhotos)*100);
        ...
        if (result.equals("OK")) {
            ...
            if (db != null) {
                try {
                    ...
                    if (contadorResults > 0) {
                        ...
                        new ProgressPH().execute(baseUrl, resultFromDBJson);
                    }
                }catch (Exception e) {
            ...
            if (db != null) {
                ...
                try {
                    ...
                    values.put(Contract.ResultsTable.TASK, "Photos");
                    ...
                    values.put(Contract.ResultsTable.TIME_AVERAGE, -1);
     ...
     */
    private class ProgressPH extends AsyncTask<String, Integer, String> {
        int contador = 0;
        ...
        protected void onPostExecute(String result){
            Log.i("PruebaDatabase" , "::: onPostExecute ");

...
public class ResultsFlex extends AppCompatActivity {
    ...
    String percentage_str, corrects_str, mistakes_str, omissions_str, score_str, time_str, averageTime_str;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Results newResults = new Results(Login.idUser, date, Login.idSesion, Login.numSesion, "Flexibility", percentageInt, correct, mistake, omission, score, timer, averageTime, -1, -1);

...
public class StatementPH extends AppCompatActivity implements CameraDetector.CameraEventListener,Detector.ImageListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainLayout = (LinearLayout) findViewById(R.id.statement_ph);

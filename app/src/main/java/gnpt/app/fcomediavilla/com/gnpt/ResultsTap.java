...
public class ResultsTap extends AppCompatActivity {
    ...
    TextView percentage, corrects, mistakes, omissions, totalTime, scores, perseveringMistakes, categoriesCompleted, percentageGraphic, averageValGraphic, averageEngGraphic, averageAttGraphic, framesDetectedGraphic, framesNoFaceGraphic;
    String percentage_str, corrects_str, mistakes_str, omissions_str, time_str, score_str, perseveringMistakes_str, categoriesCompleted_str, numFramesDetected_str, numFramesNoFace_str, att_average_str, val_average_str, eng_average_str, idUser;
    int correct, mistake, omission, timer, score, perseveringMistake, categoryCompleted, percentageInt, framesDetected, framesNoFace;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Results newResults = new Results(idUser, getCurrentTimeStamp(), Login.idSesion, Login.numSesion, "Tap", percentageInt, correct, mistake, omission, score, timer, -1, perseveringMistake, categoryCompleted, framesDetected, framesNoFace, emotion);
        ...
        if (result.equals("OK")) {
            ...
            if (db != null) {
                try {
                    ...
                    if (contadorResults > 0) {
                        ...
                        new ProgressTap().execute(baseUrl, resultFromDBJson);
                    }
                }catch (Exception e) {
            ...
            if (db != null) {
                ...
                try {
                    ...
                    values.put(Contract.ResultsTable.TASK, "Tap");
                    ...
                    values.put(Contract.ResultsTable.PERSEVERING_MISTAKES, perseveringMistake);
                    values.put(Contract.ResultsTable.COMPLETED_CATEGORY, categoryCompleted);
